...
public class CBSTM03A extends AbstractProgram {
  ...
  public static class Cbstm03aLinkage extends NGroup {
    ...
    public NInt64 alignPsa = new NInt64().digits(16);
    // COB:        01  PSA-BLOCK.
    ...
    while (!rcNext.equals(Flow.Exit)) {
      switch (rcNext) {
        ...
        case _8599Exit:
          rcNext = _8599Exit();
          break;
        case _9100TrnxfileClose:
          _9100TrnxfileClose();
          rcNext = Flow._9200XreffileClose;
          break;
        case _9200XreffileClose:
          _9200XreffileClose();
          rcNext = Flow._9300CustfileClose;
          break;
        case _9300CustfileClose:
          _9300CustfileClose();
          rcNext = Flow._9400AcctfileClose;
          break;
        case _9400AcctfileClose:
          _9400AcctfileClose();
          rcNext = Flow._9999AbendProgram;
          break;
        case _9999AbendProgram:
          _9999AbendProgram();
          rcNext = Flow.Exit;
          break;
        default:
