...
public class DSN8BC3 extends AbstractProgram {
  ...
  @ProgramStorage
  final Dsn8bc3Working ws = new Dsn8bc3Working();
  ...
  protected void initialize() {
    cardin = new SequentialFile(context, "CARDIN") //
                               .recordIs(fs.cardrec);
    repout = new SequentialFile(context, "REPORT") //
                               .recordIs(fs.reprec);
    tele1 = new NSqlCursor(this,sqlca, "SELECT * FROM VPHONE");
    tele2 = new NSqlCursor(this,sqlca, "SELECT * FROM VPHONE WHERE LASTNAME LIKE ? AND FIRSTNAME LIKE ?");
    tele2.where.add(, Types.DATEws.lnameWork) // 
.add(, Types.DATEws.fnameWork);
    tele3 = new NSqlCursor(this,sqlca, "SELECT * FROM VPHONE WHERE LASTNAME = ? AND FIRSTNAME LIKE ?");
    tele3.where.add(, Types.DATEws.ioarea.lname) // 
.add(, Types.DATEws.fnameWork);
  }
  ...
  *****************************************************/
  ...
  //                                            **UNSTRING LAST NAME  
      StringTools.unstring(ws.ioarea.lname).delimited(' ').into(ws.lnameWork.lnameWorkc).count(ws.lnameWork.lnameWorkl).exec();
      //COB(411): UNSTRING FNAME                                       
      //COB(411):    DELIMITED BY SPACE                                
      //COB(411):    INTO     FNAME-WORKC                              
      //COB(411):    COUNT IN FNAME-WORKL                              
  //                                            **UNSTRING FIRST NAME 
      StringTools.unstring(ws.ioarea.fname).delimited(' ').into(ws.fnameWork.fnameWorkc).count(ws.fnameWork.fnameWorkl).exec();
  ...
  *****************************************************/
  ...
  //                                            **GET EMPLOYEES       
    tele1.into.add(, Types.DATEws.pphone);
    tele1.fetch();
  ...
  *****************************************************/
  ...
  //                                            **GET EMPLOYEES       
    tele2.into.add(, Types.DATEws.pphone);
    tele2.fetch();
  ...
  *****************************************************/
  ...
  //                                            **GET EMPLOYEES       
    tele3.into.add(, Types.DATEws.pphone);
    tele3.fetch();
  ...
  *****************************************************/
  protected void telephoneUpdate() {
    ...
    sql.set.add(, Types.DATEws.ioarea.newno);
    sql.where.add(, Types.DATEws.ioarea.eno);
    sql.execute();
    }
